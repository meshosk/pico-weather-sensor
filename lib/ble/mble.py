...
try:
    ...
    # MicroPython-compatible fallback
...
class MBLE:
    ...
    def _advertise(self, interval_us=500000, data=None):
        print("Starting advertising")
        # Start BLE advertising with the given interval
        self._ble.gap_advertise(interval_us, adv_data=data)
